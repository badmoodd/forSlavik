...
//        double twoASquare = 2 * a2;
//        double twoBSquare = 2 * b2;
//
//        int x = 0;
//        int y = b;
//
//        drawEllipsePoints(center, x, y, color);
//
...
//            } else {
//                y--;
//                d += twoBSquare * x - twoASquare * y + a2 + b2;
//            }
//            drawEllipsePoints(center, x, y, color);
//        }
//
...
//    }
//
//    private void drawEllipsePoints(Pair<Integer, Integer> center, int x, int y, Color color) {
//        int centerX = center.getKey();
//        int centerY = center.getValue();
//
//        pixelWriter.setColor(centerX + x, centerY - y, color);
